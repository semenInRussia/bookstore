...
try
{
  ...
  {
    new Book("978-5-4461-0923-5", "CLR via C#", "Jeffrey Richter", 55.0, 3),
    new Book("978-0-1347-0779-3", "Clean Code", "Robert C. Martin", 48.5, 1),
    new Book("978-1-1188-9912-4", "C# in Depth", "Jon Skeet", 52.9, 2)
  };
